...
class MultiModalLLM(Agent):
    ...
    def choose_action(self, frames: list[FrameData], latest_frame: FrameData) -> GameAction:
        ...
        api_key = os.environ.get("OPENAI_SECRET_KEY", os.environ.get("OPENAI_API_KEY", ""))
        ...
        if self._previous_action:
            ...
            analysze_prompt = f"{level_complete}\n\n{self.ANALYSE_INSTRUCT}\n\n{self._memory_prompt}"
            ...
            msg_parts = [make_image_block(image_to_base64(img)) for img in all_imgs] + [  # just append the dict
